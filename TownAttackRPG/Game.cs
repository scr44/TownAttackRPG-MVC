...
using TownAttackRPG.Models.Scenario.Campaign.Tutorial;
using TownAttackRPG.Views.Menus.Startup;
using TownAttackRPG.Views.Menus.InfoPages;

namespace TownAttackRPG
{
    public class Game
    {
        #region Menu Objects
